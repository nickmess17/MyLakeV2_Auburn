...
lake_params = {
    ...
    1.946, 'I_scV',                % 16    scaling factor for inflow volume (-)
    ...
    1.5, 'I_scTP',               % 20    scaling factor for inflow concentration of total P (-)
    ...
    0.2109, 'swa_b0',             % 39     non-PAR light attenuation coeff. (m-1)
    1.4937, 'swa_b1',            % 40     PAR light attenuation coeff. (m-1)
